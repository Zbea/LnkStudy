...
class AppCenterActivity:BaseAppCompatActivity(),
    IContractView.IAPPView {

    private val presenter=CenterAppPresenter(this)
    private var appBean: AppList?=null
    private var apps= mutableListOf<AppList.ListBean>()
    private var wallpapers= mutableListOf<PaintingList.ListBean>()
    private var paintings= mutableListOf<PaintingList.ListBean>()
    ...
    private fun initApp(){
        ...
        mAdapterDownload?.setEmptyView(R.layout.common_empty)
    ...
    private fun initWallpaper(){
        ...
        mWallpaperListAdapter?.setEmptyView(R.layout.common_empty)
    ...
    private fun initPainting(){
        ...
        mPaintingAdapter?.setEmptyView(R.layout.common_empty)
    ...
    private fun isInstalled(): Boolean {
        val listFile = FileUtils.getFiles(File(APK_PATH).path)
        if (listFile.size > 0) {
