...
class HomeworkMessageAllActivity:BaseAppCompatActivity(),IContractView.IHomeworkView {
    ...
    private fun initRecyclerView(){
        ...
        layoutParams.setMargins(
            ...
            DP2PX.dip2px(this@HomeworkMessageAllActivity,50f),20)
        ...
        mAdapter = HomeworkMessageAllAdapter(null).apply {
            ...
            setOnChildClickListener{ item->
                ...
                when(homeworkType?.state) {
                    3 -> {
                        MethodManager.gotoHomeworkRecord(this@HomeworkMessageAllActivity, homeworkType, messageBean)
                    }
                    1, 7 -> {
                        if (HomeworkPaperDaoManager.getInstance().queryByContentID(messageBean.contendId) != null) {
                            MethodManager.gotoHomeworkReelDrawing(this@HomeworkMessageAllActivity, homeworkType, Constants.DEFAULT_PAGE, messageBean)
                        } else {
                            showLoading()
                    ...
                    4 -> {
                        if (HomeworkBookDaoManager.getInstance().isExist(homeworkType!!.bookId)) {
                            MethodManager.gotoHomeworkBookDetails(this@HomeworkMessageAllActivity, homeworkType, messageBean)
                        } else {
                            //下载教辅
                        ...
                        MethodManager.gotoHomeworkDrawing(this@HomeworkMessageAllActivity, homeworkType!!, Constants.DEFAULT_PAGE, messageBean)
                    }
                }
            }
        }
            ...
            .startMultiTaskDownLoad(
                object : FileMultitaskDownManager.MultiTaskCallBack {
                    ...
                    override fun completed(task: BaseDownloadTask?) {
                        ...
                        MethodManager.gotoHomeworkReelDrawing(this@HomeworkMessageAllActivity,homeworkType,Constants.DEFAULT_PAGE,item)
                    }
