...
/** 
 * DAO for table "PAPER_CONTENT_BEAN".
*/
public class PaperContentBeanDao extends AbstractDao<PaperContentBean, Long> {

    public static final String TABLENAME = "PAPER_CONTENT_BEAN";

    /**
     * Properties of entity PaperContentBean.<br/>
    ...
    public PaperContentBeanDao(DaoConfig config) {
        super(config);
    }
    
    public PaperContentBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PAPER_CONTENT_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PAPER_CONTENT_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, PaperContentBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PaperContentBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public PaperContentBean readEntity(Cursor cursor, int offset) {
        PaperContentBean entity = new PaperContentBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, PaperContentBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PaperContentBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PaperContentBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PaperContentBean entity) {
