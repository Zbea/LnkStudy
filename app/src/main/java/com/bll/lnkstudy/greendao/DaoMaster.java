...
/**
 * Master of DAO (schema version 117): knows all DAOs.
 */
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        CorrectDetailsBeanDao.createTable(db, ifNotExists);
        ...
        HomeworkDetailsBeanDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        CorrectDetailsBeanDao.dropTable(db, ifExists);
        ...
        HomeworkDetailsBeanDao.dropTable(db, ifExists);
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(CorrectDetailsBeanDao.class);
        ...
        registerDaoClass(HomeworkDetailsBeanDao.class);
