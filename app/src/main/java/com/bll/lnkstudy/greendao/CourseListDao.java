...
*/
public class CourseListDao extends AbstractDao<CourseList, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, CourseList entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CourseList entity) {
        stmt.clearBindings();
    ...
    @Override
    public CourseList readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, CourseList entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CourseList entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CourseList entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CourseList entity) {
