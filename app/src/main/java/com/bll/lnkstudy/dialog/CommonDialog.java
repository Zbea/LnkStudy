...
public class CommonDialog {
    ...
    public CommonDialog builder() {
        ...
        TextView titleTv = dialog.findViewById(R.id.tv_dialog_title);
        TextView contentTv = dialog.findViewById(R.id.tv_dialog_content);
        TextView cancleTv = dialog.findViewById(R.id.tv_cancle);
        okTv=dialog.findViewById(R.id.tv_ok);
